puts 'Seeded Clinical Trials Metadata (MIMCT) V0.8'
...
unless ExtendedMetadataType.where(title:'MIMCT Metadata V0.8 for object type Investigation', supported_type:'Investigation').any?
  emt = ExtendedMetadataType.new(title: 'MIMCT Metadata V0.8 for object type Investigation', supported_type: 'Investigation')
  emt.extended_metadata_attributes << ExtendedMetadataAttribute.new(title: 'study_acronym',      required: false, sample_attribute_type: string_type, description: 'Short abbreviation referencing the study', label: 'Study acronym')
  emt.extended_metadata_attributes << ExtendedMetadataAttribute.new(title: 'study_identifier',   required: false, sample_attribute_type: string_type, description: 'Identifier from a clinical trial registry', label: 'Study identifier')
  emt.extended_metadata_attributes << ExtendedMetadataAttribute.new(title: 'study_start_date',   required: false, sample_attribute_type: date_type, description: 'Actual or planned, if applicable', label: 'Study start date')
  emt.extended_metadata_attributes << ExtendedMetadataAttribute.new(title: 'study_end_date',     required: false, sample_attribute_type: date_type, description: 'Actual or planned, if applicable', label: 'Study end date')
  emt.extended_metadata_attributes << ExtendedMetadataAttribute.new(title: 'study_homepage',     required: false, sample_attribute_type: link_type, description: 'Specific website for study content', label: 'Study homepage')
  ...
  emt.extended_metadata_attributes << ExtendedMetadataAttribute.new(title: 'study_type',         required: false, sample_attribute_type: cv_type, sample_controlled_vocab: study_type_cv, description: 'Feasibility or screening studies generate a patient collective in preparation for a research study', label: 'Study type')
  emt.extended_metadata_attributes << ExtendedMetadataAttribute.new(title: 'study_condition',    required: false, sample_attribute_type: linked_extended_metadata_type_list, linked_extended_metadata_type: ExtendedMetadataType.where(title:'study_condition', supported_type:'ExtendedMetadata').first, description: 'The conditions, problems or diagnosis codes that are the focus of the study', label: 'Health conditions studied')                                                                 
  ...
  emt.extended_metadata_attributes << ExtendedMetadataAttribute.new(title: 'study_status',       required: false, sample_attribute_type: cv_type, sample_controlled_vocab: study_status_cv, description: 'Active means the study is in planning or running, completed means it has ended and no further modifications to the data are expected', label: 'Study status')
  ...
  emt.extended_metadata_attributes << ExtendedMetadataAttribute.new(title: 'study_dmp',          required: false, sample_attribute_type: cv_type, sample_controlled_vocab: study_dmp_cv, description: 'Presence of plan for data sharing in compliance with consent of subject', label: 'Data Management Plan for data sharing?')
  emt.save!
  puts 'MIMCT Metadata V0.8 for SEEK type Investigation'
end
...
unless ExtendedMetadataType.where(title:'MIMCT Metadata V0.8 for object type Study', supported_type:'Study').any?
  emt = ExtendedMetadataType.new(title: 'MIMCT Metadata V0.8 for object type Study', supported_type: 'Study')
  emt.extended_metadata_attributes << ExtendedMetadataAttribute.new(title: 'study_acronym',      required: false, sample_attribute_type: string_type, description: 'Short abbreviation referencing the study', label: 'Study Acronym')
  emt.extended_metadata_attributes << ExtendedMetadataAttribute.new(title: 'study_identifier',   required: false, sample_attribute_type: string_type, description: 'Identifier from a clinical trial registry', label: 'Study Identifier')
  emt.extended_metadata_attributes << ExtendedMetadataAttribute.new(title: 'study_start_date',   required: false, sample_attribute_type: date_type, description: 'Actual or planned, if applicable', label: 'Study Start Date')
  emt.extended_metadata_attributes << ExtendedMetadataAttribute.new(title: 'study_end_date',     required: false, sample_attribute_type: date_type, description: 'Actual or planned, if applicable', label: 'Study End Date')
  ...
  emt.save!
  puts 'MIMCT Metadata V0.8 for SEEK type Study'
end
